function SegmentAvancement(obj,event)
...
ValeurDep=str2double(get(findobj('tag','indicdeplacement'),'String'));
if [XlimMaxi XlimMaxi]>(Curseur_Fin{1}+ValeurDep)
    Curseur_Debut_Suivant=Curseur_Debut{1}+ValeurDep;
    Curseur_Fin_Suivant=Curseur_Fin{1}+ValeurDep;
else
